  ...
  return (
    <div>
      {getUser.data?.map((item, index) => (
        <div key={index + 1} className="space-y-4 xl:space-y-6 rounded-2xl shadow-2xl">
          <img
          ...
          <div className="space-y-2">
            <div className="flex justify-center items-center flex-col space-y-3 text-lg font-medium leading-6">
              <h3 className="text-black">{item.fullname}</h3>
          ...
          {/* button profile menu */}
          <div className="font-bold text-xl p-4 shadow-xl rounded-lg">
            <Link to={"/ruang/v1/profile-user"}>
              <div className="grid grid-cols-3 place-items-center mt-4 hover:text-blue-600">
                <icons.FaUserAlt size={20} className="" />
            ...
            <Link to={"/ruang/v1/profile-user/add/puisi"}>
              <div className="grid grid-cols-3 place-items-center mt-6 hover:text-blue-600">
                <icons.AiOutlineFileAdd size={20} />
                <h1>Add Write</h1>
                <icons.FaArrowRight size={20} />
              </div>
            </Link>
            <Link onClick={logout}>
              <div className="grid grid-cols-3 place-items-center mt-6 mb-6 text-red-500 hover:text-blue-600">
                <icons.ImExit size={20} className="" />
                <h1 className="">LogOut</h1>
                <icons.FaArrowRight size={20} className="" />
              </div>
            </Link>
          </div>
          {/* end button profile menu */}
        </div>
      ))}
    </div>
  );
